...
export const VKIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
  <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
    <text x="0" y="19" fontSize="18" fontWeight="bold" fontFamily="Arial, sans-serif" fill="currentColor">VK</text>
  </svg>
)
...
export const MAXIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
  <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
    <text x="5" y="19" fontSize="18" fontWeight="bold" fontFamily="Arial, sans-serif" fill="currentColor">M</text>
  </svg>
)
